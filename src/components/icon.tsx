...
export const Icon = {
  Award: ({ className = "", testid = "icon-award" }) => (
    <svg
  ...
  Brand: ({ className = "", testid = "icon-brand" }) => (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      className={className}
      viewBox="0 0 20 20"
  ...
  Catalog: ({ className = "", testid = "icon-catalog" }) => (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      className={className}
      viewBox="0 0 20 20"
  ...
  Circle: ({ className = "", testid = "icon-circle" }) => (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      className={className}
      viewBox="0 0 20 20"
  ...
  Data: ({ className = "", testid = "icon-data" }) => (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      className={className}
      viewBox="0 0 20 20"
  ...
  DataModel: ({ className = "", testid = "icon-data-model" }) => (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      className={className}
      viewBox="0 0 20 20"
  ...
  Donor: ({ className = "", testid = "icon-donor" }) => (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      className={className}
      viewBox="0 0 20 20"
  ...
  FileSet: ({ className = "", testid = "icon-fileset" }) => (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      className={className}
      viewBox="0 0 20 20"
  ...
  Filter: ({ className = "", testid = "icon-filter" }) => (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      className={className}
      viewBox="0 0 20 20"
  ...
  Gene: ({ className = "", testid = "icon-gene" }) => (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      className={className}
      viewBox="0 0 20 20"
  ...
  Methodology: ({ className = "", testid = "icon-methodology" }) => (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      className={className}
      viewBox="0 0 20 20"
  ...
  PencilSlash: ({ className = "", testid = "icon-pencil-slash" }) => (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      className={className}
      viewBox="0 0 20 20"
  ...
  Sample: ({ className = "", testid = "icon-sample" }) => (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      className={className}
      viewBox="0 0 20 20"
  ...
  Splat: ({ className = "", testid = "icon-splat" }) => (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      className={className}
      viewBox="0 0 20 20"
  ...
  Treatment: ({ className = "", testid = "icon-treatment" }) => (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      className={className}
      viewBox="0 0 20 20"
  ...
  Twitter: ({ className = "", testid = "icon-twitter" }) => (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      className={className}
      viewBox="0 0 20 20"
  ...
  UserSignedIn: ({ className = "", testid = "icon-user-signed-out" }) => (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      className={className}
      viewBox="0 0 20 20"
  ...
  UserSignedOut: ({ className = "", testid = "icon-user-signed-out" }) => (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      className={className}
      viewBox="0 0 20 20"
