 ...
 * around horizontally.
 * @param {number} currentPage The currently selected page number
 * @param {number} totalPages The total number of pages available
 * @param {function} onClick Callback function to call when the user clicks a page number
 * @param {string} [className] Additional CSS classes to apply to the pager
 */
